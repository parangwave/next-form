...
export const baseTabItems: ITabPath[] = [
  {
    ...
    href: "/",
    icon: {
      active: <HomeIconFill className="text-slate-700" />,
      inactive: <HomeIconLine />,
    },
  },
  {
    label: "검색",
    href: "/search",
    icon: {
      active: <SearchIconFill className="size-20 text-slate-700" />,
      inactive: <SearchIconLine className="size-20" />,
    },
  },
  {
    label: "추가",
    href: "/tweets/add",
    icon: {
      active: <PlusCircleIconFill className="size-20 text-slate-700" />,
      inactive: <PlusCircleIconLine className="size-20" />,
    },
  },
  {
    label: "좋아요",
    href: "/likes",
    icon: {
      active: <HeartIconFill className="size-20 text-slate-700" />,
      inactive: <HeartIconLine />,
    },
  },
  {
    label: "프로필",
    href: "/users/:id",
    icon: {
      active: <UserIconFill className="size-20 text-slate-700" />,
      inactive: <UserIconLine />,
    },
  },
];
